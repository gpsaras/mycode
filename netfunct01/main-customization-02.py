...
def devicereboot(devicecmd): # devicecmd==dict
    ...
    for ip in devicecmd.keys(): # looping throught the dict
        
        print(f'{crayons.red("Connecting to")}. .. ... REBOOTING NOW! {ip}') # fstring with RED
    return None
...
def main():
    ...
    devicereboot(devicecmd) # call function to print a list of IP's being connected to
